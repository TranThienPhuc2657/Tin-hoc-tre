...
int main() {
    ...
    //Ý tưởng: với mỗi trạng thái ta sẽ sinh ra 32 trạng thái mới (16 trạng thái làm thao tác 1 ở bất cứ điểm nào và 16 trạng thái làm thao tác 2 ở bất cứ điểm nào từ 
    //trạng thái hiện tại. Với mỗi trạng thái, ta xem nó như 1 đỉnh (ta sẽ quy một trạng thái dạng bảng 0 và 1 thành một dãy nhị phân 0 và 1. Ta sẽ làm điều này bằng bitwise)
